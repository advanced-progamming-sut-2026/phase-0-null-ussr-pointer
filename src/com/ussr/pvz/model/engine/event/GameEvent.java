...
public sealed interface GameEvent permits GameEvent.FreezingWindTriggered, GameEvent.GameOver, GameEvent.GameWon,
        GameEvent.GlowingZombieDroppedPlantFood, GameEvent.GraveDestroyed, GameEvent.LawnMowerTriggered,
        GameEvent.MeowBonusEarned, GameEvent.MeowScoreMilestone, GameEvent.PlantDamaged, GameEvent.PlantDied,
        GameEvent.PlantFoodDropped, GameEvent.PlantFoodUsed, GameEvent.PlantIncinerated, GameEvent.PlantPlanted,
        GameEvent.PlantPlucked, GameEvent.ProjectileFired, GameEvent.ProjectileHit, GameEvent.ReactionReceivedEvent,
        GameEvent.SandstormTriggered, GameEvent.SpecialLevelAnnouncement, GameEvent.StructureDestroyed,
        GameEvent.SunAbsorbedByZombie, GameEvent.SunCollected, GameEvent.SunExpired, GameEvent.SunGrounded,
        GameEvent.SunProduced, GameEvent.SunStartedFalling, GameEvent.WaveStarted, GameEvent.WavesCompleted,
        GameEvent.ZombieBreachedLane, GameEvent.ZombieDied, GameEvent.ZombieReachedHouse, GameEvent.ZombieSpawned {
