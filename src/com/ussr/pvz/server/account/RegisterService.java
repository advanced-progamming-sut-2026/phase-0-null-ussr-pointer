...
public class RegisterService {
    ...
    public PendingRegistrationResult register(
        ...
        if (validationError != null) {
            return PendingRegistrationResult.error(
                    validationError
            );
        }

        Map<String, Integer> initialPlantMap =
    ...
    public RegistrationResult pickQuestion(
        ...
        SecurityQuestion chosenQuestion =
                questions[questionNumber - 1];

        AccountState finalState =
                pendingAccount.finalizeRegistration(
                        chosenQuestion,
                        request.answer()
                );
